...
And you should be able to navigate to http://localhost:30080 and recive the result of the server instance that is running on the cluster but simultaneously you should also see the **following log in the local machine**
